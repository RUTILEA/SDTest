...
class Ui_Dataset(object):
    def setupUi(self, Dataset):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/fonts/fontawesome/dumbbell#666666.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_0.setIcon(0, icon)
        item_0.setFlags(QtCore.Qt.ItemIsEnabled)
        item_1 = QtWidgets.QTreeWidgetItem(item_0)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/fonts/fontawesome/font-awesome_4-7-0_check-circle_32_4_3fda68_none.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon1)
        item_0 = QtWidgets.QTreeWidgetItem(self.image_list_widget)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/fonts/fontawesome/test_custom#666666.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        item_1 = QtWidgets.QTreeWidgetItem(item_0)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/fonts/fontawesome/font-awesome_4-7-0_times-circle_32_4_e66643_none.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/fonts/fontawesome/font-awesome_4-7-0_image_32_4_3e3e3e_none.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/fonts/fontawesome/font-awesome_4-7-0_camera_32_4_3e3e3e_none.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)

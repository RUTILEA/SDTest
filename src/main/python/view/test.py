...
class TestWidget(QWidget):
    ...
    def reload_test_results(self, show_training=False):
        ...
        sns.set()
        if show_training:
            sns.distplot(results.distances_of_train_images, kde=False, rug=False, label='TRAIN OK')
        sns.distplot(results.distances_of_ng_images, kde=False, rug=False, label='TEST NG')
        sns.distplot(results.distances_of_ok_images, kde=False, rug=False, label='TEST OK')  # FIXME: label
        plt.legend()
